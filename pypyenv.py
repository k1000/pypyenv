...
def main():
    ...
    if linux and x86:
        download = "https://bitbucket.org/pypy/pypy/downloads/pypy-1.8-linux.tar.bz2"
    elif linux and x86_64:
        download = "https://bitbucket.org/pypy/pypy/downloads/pypy-1.8-linux64.tar.bz2"
    elif osx:
        download = "https://bitbucket.org/pypy/pypy/downloads/pypy-1.8-osx64.tar.bz2"
